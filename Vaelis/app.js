...
const workbookPath = character ? `${character.root}${character.workbook}` : '';
...
function imageFor(name) {
  ...
  return images[key(name)] ? `${character.root}${character.imageFolder}${images[key(name)]}` : '';
}
